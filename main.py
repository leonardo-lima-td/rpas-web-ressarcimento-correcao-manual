...
def main():
    ...
    for index, row in df.iterrows():
        ...
        print(query)
        path_local_recibo = p.Path(__file__).parent.joinpath('recibos/recibo_' + perdcomp + '.pdf').absolute()
        ...
        path_local_recibo_renomeado = path_local_recibo.replace('recibos/recibo-perdcomp_', 'recibos/recibo_')
